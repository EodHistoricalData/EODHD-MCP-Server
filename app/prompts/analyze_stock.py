...
def register(mcp: FastMCP):
    ...
    def analyze_stock(ticker: str) -> str:
        ...
        return (
            ...
            f"identify price trend and momentum.\n"
            f"3. **get_support_resistance_levels** for {ticker} (method='classic') over the last 3 months — "
            f"identify key support/resistance levels and pivot points.\n"
            f"4. **get_technical_indicators** for {ticker} (SMA, RSI) — "
            f"confirm trend direction and overbought/oversold conditions.\n"
            f"5. **get_company_news** for {ticker} (last 30 days) — "
