...
_PAGE_REGISTRY: dict[int, dict[int, tuple[str, str]]] = {
    ...
    2: {
        ...
        5: ("endpoints", "congressional-trades.md"),
        6: ("endpoints", "credit-cds-market-aggregates.md"),
        7: ("endpoints", "credit-corporate-cmdi.md"),
        8: ("endpoints", "credit-corporate-hqm-yields.md"),
        9: ("endpoints", "credit-sovereign-cds-spreads.md"),
        10: ("endpoints", "credit-sovereign-credit-ratings.md"),
        11: ("endpoints", "credit-sovereign-default-spreads.md"),
        12: ("endpoints", "credit-sovereign-risk-premium.md"),
        13: ("endpoints", "earnings-trends.md"),
        14: ("endpoints", "economic-events.md"),
        15: ("endpoints", "exchange-details.md"),
        16: ("endpoints", "exchange-tickers.md"),
        17: ("endpoints", "exchanges-list.md"),
        18: ("endpoints", "fundamentals-data.md"),
        19: ("endpoints", "historical-market-cap.md"),
        20: ("endpoints", "historical-stock-prices.md"),
        ...
        47: ("endpoints", "rates-funding-stress.md"),
        48: ("endpoints", "rates-policy-rates.md"),
        49: ("endpoints", "rates-reference-rates.md"),
        50: ("endpoints", "real-estate-countries.md"),
        51: ("endpoints", "real-estate-detailed-prices.md"),
        52: ("endpoints", "real-estate-detailed-series.md"),
        53: ("endpoints", "real-estate-selected-prices.md"),
        54: ("endpoints", "sanctions-entities.md"),
        55: ("endpoints", "sanctions-programs.md"),
        56: ("endpoints", "sanctions-sources.md"),
        57: ("endpoints", "sanctions-vessels.md"),
        58: ("endpoints", "sentiment-data.md"),
        59: ("endpoints", "stock-market-logos.md"),
        60: ("endpoints", "stock-market-logos-svg.md"),
        61: ("endpoints", "stock-screener-data.md"),
        62: ("endpoints", "stocks-from-search.md"),
        63: ("endpoints", "symbol-change-history.md"),
        64: ("endpoints", "technical-indicators.md"),
        65: ("endpoints", "tradinghours-list-markets.md"),
        66: ("endpoints", "tradinghours-lookup-markets.md"),
        67: ("endpoints", "tradinghours-market-details.md"),
        68: ("endpoints", "tradinghours-market-status.md"),
        69: ("endpoints", "upcoming-dividends.md"),
        70: ("endpoints", "upcoming-earnings.md"),
        71: ("endpoints", "upcoming-ipos.md"),
        72: ("endpoints", "upcoming-splits.md"),
        73: ("endpoints", "us-live-extended-quotes.md"),
        74: ("endpoints", "us-options-contracts.md"),
        75: ("endpoints", "us-options-eod.md"),
        76: ("endpoints", "us-options-underlyings.md"),
        77: ("endpoints", "us-tick-data.md"),
        78: ("endpoints", "user-details.md"),
        79: ("endpoints", "ust-bill-rates.md"),
        80: ("endpoints", "ust-long-term-rates.md"),
        81: ("endpoints", "ust-real-yield-rates.md"),
        82: ("endpoints", "ust-yield-rates.md"),
        83: ("endpoints", "websockets-realtime.md"),
    },
...
def register(mcp: FastMCP):
    ...
    async def retrieve_description_by_id(
        ...
        Endpoint documentation pages (type=2):
          ...
          4 — Company News, 5 — Congressional Trades,
          6-12 — Credit & Sovereign Risk
          ...
          13 — Earnings Trends, 14 — Economic Events,
          15 — Exchange Details, 16 — Exchange Tickers, 17 — Exchanges List,
          18 — Fundamentals Data, 19 — Historical Market Cap,
          20 — Historical Stock Prices, 21 — Index Components,
          22 — Indices List, 23 — Insider Transactions,
          ...
          35-46 — PRAAMS endpoints,
          47-49 — Interest Rates (Funding Stress, Policy Rates, Reference Rates),
          50-53 — Real Estate (Country Codes, Detailed Prices,
          Detailed Series, Selected Prices),
          54-57 — Sanctions (Entities, Programs, Sources, Vessels),
          58 — Sentiment Data,
          59 — Stock Market Logos, 60 — Stock Market Logos SVG,
          61 — Stock Screener Data, 62 — Stocks From Search,
          63 — Symbol Change History, 64 — Technical Indicators,
          65-68 — Trading Hours, 69 — Upcoming Dividends,
          70 — Upcoming Earnings, 71 — Upcoming IPOs,
          72 — Upcoming Splits, 73 — US Live Extended Quotes,
          74-76 — US Options, 77 — US Tick Data, 78 — User Details,
          79-82 — UST Rates, 83 — WebSockets Realtime
