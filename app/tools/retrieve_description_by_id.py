...
_PAGE_REGISTRY: dict[int, dict[int, tuple[str, str]]] = {
    ...
    2: {
        ...
        13: ("endpoints", "index-components.md"),
        14: ("endpoints", "indices-list.md"),
        15: ("endpoints", "insider-transactions.md"),
        16: ("endpoints", "intraday-historical-data.md"),
        17: ("endpoints", "investverte-esg-list-companies.md"),
        18: ("endpoints", "investverte-esg-list-countries.md"),
        19: ("endpoints", "investverte-esg-list-sectors.md"),
        20: ("endpoints", "investverte-esg-view-company.md"),
        21: ("endpoints", "investverte-esg-view-country.md"),
        22: ("endpoints", "investverte-esg-view-sector.md"),
        23: ("endpoints", "live-price-data.md"),
        24: ("endpoints", "macro-indicator.md"),
        25: ("endpoints", "marketplace-tick-data.md"),
        26: ("endpoints", "news-word-weights.md"),
        27: ("endpoints", "praams-bank-balance-sheet-by-isin.md"),
        28: ("endpoints", "praams-bank-balance-sheet-by-ticker.md"),
        29: ("endpoints", "praams-bank-income-statement-by-isin.md"),
        30: ("endpoints", "praams-bank-income-statement-by-ticker.md"),
        31: ("endpoints", "praams-bond-analyze-by-isin.md"),
        32: ("endpoints", "praams-report-bond-by-isin.md"),
        33: ("endpoints", "praams-report-equity-by-isin.md"),
        34: ("endpoints", "praams-report-equity-by-ticker.md"),
        35: ("endpoints", "praams-risk-scoring-by-isin.md"),
        36: ("endpoints", "praams-risk-scoring-by-ticker.md"),
        37: ("endpoints", "praams-smart-investment-screener-bond.md"),
        38: ("endpoints", "praams-smart-investment-screener-equity.md"),
        39: ("endpoints", "sentiment-data.md"),
        40: ("endpoints", "stock-market-logos.md"),
        41: ("endpoints", "stock-market-logos-svg.md"),
        42: ("endpoints", "stock-screener-data.md"),
        43: ("endpoints", "stocks-from-search.md"),
        44: ("endpoints", "symbol-change-history.md"),
        45: ("endpoints", "technical-indicators.md"),
        46: ("endpoints", "tradinghours-list-markets.md"),
        47: ("endpoints", "tradinghours-lookup-markets.md"),
        48: ("endpoints", "tradinghours-market-details.md"),
        49: ("endpoints", "tradinghours-market-status.md"),
        50: ("endpoints", "upcoming-dividends.md"),
        51: ("endpoints", "upcoming-earnings.md"),
        52: ("endpoints", "upcoming-ipos.md"),
        53: ("endpoints", "upcoming-splits.md"),
        54: ("endpoints", "us-live-extended-quotes.md"),
        55: ("endpoints", "us-options-contracts.md"),
        56: ("endpoints", "us-options-eod.md"),
        57: ("endpoints", "us-options-underlyings.md"),
        58: ("endpoints", "us-tick-data.md"),
        59: ("endpoints", "ust-bill-rates.md"),
        60: ("endpoints", "ust-long-term-rates.md"),
        61: ("endpoints", "ust-real-yield-rates.md"),
        62: ("endpoints", "ust-yield-rates.md"),
        63: ("endpoints", "user-details.md"),
        64: ("endpoints", "websockets-realtime.md"),
    },
...
def register(mcp: FastMCP):
    ...
    async def retrieve_description_by_id(
        ...
        Types:
          ...
          2 — Endpoint documentation (ids 1-64; id 0 = endpoints README)
        ...
        Endpoint documentation pages (type=2):
          ...
          12 — Historical Stock Prices, 13 — Index Components,
          14 — Indices List, 15 — Insider Transactions,
          16 — Intraday Historical Data, 17-22 — Investverte ESG,
          23 — Live Price Data, 24 — Macro Indicator,
          25 — Marketplace Tick Data, 26 — News Word Weights,
          27-38 — PRAAMS endpoints, 39 — Sentiment Data,
          40 — Stock Market Logos, 41 — Stock Market Logos SVG,
          42 — Stock Screener Data, 43 — Stocks From Search,
          44 — Symbol Change History, 45 — Technical Indicators,
          46-49 — Trading Hours, 50 — Upcoming Dividends,
          51 — Upcoming Earnings, 52 — Upcoming IPOs,
          53 — Upcoming Splits, 54 — US Live Extended Quotes,
          55-57 — US Options, 58 — US Tick Data, 59-62 — UST Rates,
          63 — User Details, 64 — WebSockets Realtime
