...
def register(mcp: FastMCP):
    ...
    async def retrieve_description_by_id(
        ...
        Types:
          ...
          2 — Endpoint documentation (ids 1-78; id 0 = endpoints README)
        ...
        Endpoint documentation pages (type=2):
          ...
          49-52 — Sanctions (Entities, Programs, Sources, Vessels),
          53 — Sentiment Data,
          54 — Stock Market Logos, 55 — Stock Market Logos SVG,
          56 — Stock Screener Data, 57 — Stocks From Search,
          58 — Symbol Change History, 59 — Technical Indicators,
          60-63 — Trading Hours, 64 — Upcoming Dividends,
          65 — Upcoming Earnings, 66 — Upcoming IPOs,
          67 — Upcoming Splits, 68 — US Live Extended Quotes,
          69-71 — US Options, 72 — US Tick Data, 73 — User Details,
          74-77 — UST Rates, 78 — WebSockets Realtime
