# app/tools/get_mp_illio_market_insights_risk_return.py
...
async def _run_risk_return(id: str, fmt: str, api_token: str | None) -> ResourceResponse:
    # Validate fmt
    ...
    url = build_url(f"mp/illio/chapters/risk/{cid}", {"fmt": "json", "api_token": api_token})
